...
inputs:
  ...
  - id: reference_genome
    ...
    default:
      class: File
      format: edam:format_1929
      location: /Volumes/externalSSD4M3Max/test_dir_4_update-gtf_cwl/Data/Danio_rerio/GCF_000002035.6_GRCz11_genomic.fna
  - id: reference_genome_annotation
    ...
    default:
      class: File
      format: edam:format_2306
      location: /Volumes/externalSSD4M3Max/test_dir_4_update-gtf_cwl/Data/Danio_rerio/GCF_000002035.6_GRCz11_genomic.gtf
  - id: star_threads
    type: int
