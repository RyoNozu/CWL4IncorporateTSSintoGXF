...
"""
Update GTF/GFF file with TSS features
Modified from 10_draft_update_gtf_add_all.assignedClusters_TSS-feature_v20250403-01.py


Usage:
  python3 10_update_gtf.py --gtf_file <input_gtf_file> --tss_file <input_tss_file> --output_file <output_gtf_file>
...
def extract_gene_id(attribute_column, file_type):
    """
    Extract gene_id from attribute column of GTF or GFF file
    """
    if file_type == "gtf":
...
def extract_transcript_id(attribute_column, file_type):
    """
    Extract transcript_id from attribute column of GTF or GFF file
    """
    if file_type == "gtf":
...
if __name__ == "__main__":
    # コマンドライン引数の設定
    parser = argparse.ArgumentParser(description="Update GTF/GFF file with TSS features")
    parser.add_argument("--gtf_file", help="Input GTF or GFF file path")  # 修正
    parser.add_argument("--tss_file", help="Input TSS file path")  # 修正
    parser.add_argument("--output_file", help="Output GTF file path")  # 修正
